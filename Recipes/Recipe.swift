...
final class Recipe {
  ...
  init(
    id: UUID = UUID(), title: String, author: String, date: Date, timeRequired: String,
    servings: String, expertiseRequired: String, caloriesPerServing: String, ingredients: String,
    instructions: String, category: [RecipeCategory], favorite: Bool
  ) {
    self.id = id
    self.title = title
    self.author = author
